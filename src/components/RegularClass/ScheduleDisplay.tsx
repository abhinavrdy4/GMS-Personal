  ...
  return (
    <div className="space-y-8">
      ...
      <div className="space-y-4">
        <h3 className="text-lg font-semibold">Weekday Batches</h3>
        <div className="space-y-4">
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <div className="space-y-2">
                {schedule.weekday.timeSlots.map((slot, index) => (
                  <div
                    key={index}
      ...
      {/* Weekend Schedule */}
      <div className="space-y-4">
        <h3 className="text-lg font-semibold">Weekend Batches</h3>
        <div className="space-y-4">
          <div className="flex items-start gap-3">
            <Calendar className="w-5 h-5 text-purple-600 mt-1 flex-shrink-0" />
            <div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <h4 className="font-medium mb-2">Time Slots</h4>
              <div className="space-y-2">
                {schedule.weekend.timeSlots.map((slot, index) => (
                  <div
                    key={index}
                    className="px-3 py-2 rounded-lg bg-gray-100 text-gray-700 text-sm"
                  >
